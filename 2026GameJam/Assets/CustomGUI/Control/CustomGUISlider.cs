...
public class CustomGUISlider : CustomGUIControl
{
    ...
    protected override void StyleOnDraw()
    {
        ...
        {
            case E_Slider_Type.Horizontal:
                nowValue = GUI.HorizontalSlider(guiPos.Pos, nowValue, minValue, maxValue,style,styleToThumb);
                break;
            case E_Slider_Type.Vertical:
                nowValue = GUI.VerticalSlider(guiPos.Pos, nowValue, minValue, maxValue, style, styleToThumb);
                break;
        }
        if (oldValue != nowValue)
        {
